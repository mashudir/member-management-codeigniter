		...
		<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
			<div class="d-flex align-items-center">
				...
				<a href="index.html" class="mr-7">
					<img alt="Logo" src="<?php echo base_url() ?>assets/media/logos/ppd.jpeg" class="max-h-80px" />
				</a>
				<!--end::Logo-->
				<!--begin::Dropdown-->
									...
									<div class="topbar-item">
										<div class="btn btn-icon w-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
											<div class="d-flex text-right pr-3">
												...
												<span class="text-white font-weight-bolder font-size-sm d-none d-md-inline"><?php echo $this->session->userdata("ses_name"); ?></span>
											</div>
										</div>
									</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="">
										<span class="symbol symbol-36">
											<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-15">Logout</span>
										</span>
									</a>
									<!--end::User-->
								</div>
								...
								<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
									...
									<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
										...
										<ul class="menu-nav">
												...
												<div class="menu-submenu menu-submenu-classic menu-submenu-left">
													<ul class="menu-subnav">
														<?php foreach ($this->data['groups'] as $k => $v): ?>
															...
															<a href="<?php echo base_url('member?name='.$v["name"].'&id='.$v["id"].' ') ?>" class="menu-link">
											...
											<?php if ($this->session->userdata('ses_role') == 'kmm_desa' or $this->session->userdata('ses_role') == 'ppd') { ?>
											<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
												<a href="javascript:;" class="menu-link menu-toggle">
