				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-header border-0 py-5">
						<h3 class="card-title align-items-start flex-column">
							<span class="card-label font-weight-bolder text-dark">Groups List</span>
						</h3>
						...
						<div class="card-body">
							<table id="example" class="display" style="width:100%">
								...
								<tbody>
									<?php
									$i = 1;
									foreach ($this->data['grups'] as $k => $v): ?>
										<tr>
											...
											<td class="text-center">
												...
												<a href="#!" title="Delete member" onclick="deleteConfirm('<?php echo base_url('master/delete_group/'.$v->id) ?>')">
